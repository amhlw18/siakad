            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form id="quickForm" method="post" action="/dashboard/ruangan/{{$ruangan->id}}" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_ruangan"
                                           ...
                                           placeholder="Nama Ruangan" value="{{ old('nama_ruangan',$ruangan->nama_ruangan) }}" required>
                                    @error('nama_ruangan')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="gedung"
                                           ...
                                           placeholder="Gedung" value="{{ old('gedung', $ruangan->gedung) }}" required>
                                    @error('gedung')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="lantai"
                                           ...
                                           placeholder="Lantai" value="{{ old('lantai',$ruangan->lantai) }}" required>
                                    @error('lantai')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
