            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <form id="quickForm" method="post" action="/dashboard/data-mahasiswa" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_mhs"
                                           ...
                                           placeholder="Nama Mahasiswa" value="{{ old('nama_mhs') }}" required>
                                    @error('nama_mhs')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select rounded-0 @error('status_masuk') is-invalid @enderror"
                                        ...
                                        <option value="Peserta Didik Baru" {{ old('status_masuk') == 'Peserta Didik Baru' ? 'selected' : '' }}>Peserta Didik Baru</option>
                                        <option value="Pindahan" {{ old('status_masuk') == 'Pindahan' ? 'selected' : '' }}>Pindahan</option>
                                        <option value="Pindahan Alih Bentuk" {{ old('status_masuk') == 'Pindahan Alih Bentuk' ? 'selected' : '' }}>Pindahan Alih Bentuk</option>
                                        <option value="Alih Jenjang" {{ old('status_masuk') == 'Alih Jenjang' ? 'selected' : '' }}>Alih Jenjang</option>
                                        <option value="Lintas Jalur" {{ old('status_masuk') == 'Lintas Jalur' ? 'selected' : '' }}>Lintas Jalur</option>
                                        <option value="Naik Kelas" {{ old('status_masuk') == 'Naik Kelas' ? 'selected' : '' }}>Naik Kelas</option>
                                        <option value="Akselerasi" {{ old('status_masuk') == 'Akselerasi' ? 'selected' : '' }}>Akselerasi</option>
                                        <option value="Mengulang" {{ old('status_masuk') == 'Mengulang' ? 'selected' : '' }}>Mengulang</option>
                                        <option value="Lanjut Semester" {{ old('status_masuk') == 'Lanjut Semester' ? 'selected' : '' }}>Lanjut Semester</option>
                                        <option value="Rekognisi Pembelajaran Lampau" {{ old('status_masuk') == 'Rekognisi Pembelajaran Lampau' ? 'selected' : '' }}>Rekognisi Pembelajaran Lampau</option>
                                        <option value="Course" {{ old('status_masuk') == 'Course' ? 'selected' : '' }}>Course</option>
                                        <option value="Fast Track" {{ old('status_masuk') == 'Fast Track' ? 'selected' : '' }}>Fast Track</option>
                                    </select>
                                    @error('status_masuk')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select rounded-0 @error('program') is-invalid @enderror"
                                        ...
                                        <option value="Non Reguler" {{ old('program') == 'Non Reguler' ? 'selected' : '' }}>Non Reguler</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tahun_masuk"
                                           ...
                                           placeholder="Tahun Masuk" value="{{ old('tahun_masuk') }}" required>
                                    @error('alamat')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
