            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form id="quickForm" method="post" action="/dashboard/kurikulum/{{ $kurikulum->kode_kurikulum }}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="kode_kurikulum"
                                        class="form-control @error('kode_kurikulum') is-invalid @enderror"
                                        id="kode_kurikulum" placeholder="Kode Kurikulum"
                                        value="{{ old('kode_kurikulum', $kurikulum->kode_kurikulum) }}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_kurikulum"
                                        ...
                                        id="nama_kurikulum" placeholder="Nama Kurikulum"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="sks_wajib"
                                        class="form-control @error('sks_wajib') is-invalid @enderror" id="sks_wajib"
                                        placeholder="SKS Wajib" value="{{ old('sks_wajib', $kurikulum->sks_wajib) }}"
                                        required>
                                    @error('sks_wajib')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="sks_pilihan"
                                        class="form-control @error('sks_pilihan') is-invalid @enderror" id="sks_pilihan"
                                        placeholder="SKS Pilihan" value="{{ old('sks_pilihan', $kurikulum->sks_pilihan) }}"
                                        required>
                                    @error('sks_pilihan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="jumlah_sks"
                                        ...
                                        placeholder="Jumlah SKS" value="{{ old('jumlah_sks', $kurikulum->jumlah_sks) }}"
                                        required>
                                    @error('jumlah_sks')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" name="status" id="status" value="1"
                                        {{ old('status', $kurikulum->status) == 1 ? 'checked' : '' }}>
