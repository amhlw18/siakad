                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Form Ubah Data Matakuliah <small></small></h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form id="quickForm" method="post" action="/dashboard/matakuliah/{{ $matkul->kode_mk }}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="kode_mk"
                                        ...
                                        placeholder="Kode Mata Kuliah" value="{{ old('kode_mk', $matkul->kode_mk) }}"
                                        required>
                                    @error('kode_mk')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_mk"
                                        ...
                                        placeholder="Nama Mata Kuliah" value="{{ old('nama_mk', $matkul->nama_mk) }}"
                                        required>
                                    @error('nama_mk')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="sks_teori"
                                        ...
                                        placeholder="SKS Teori" value="{{ old('sks_teori', $matkul->sks_teori) }}"
                                        required>
                                    @error('sks_teori')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="sks_praktek"
                                        ...
                                        placeholder="SKS Praktek" value="{{ old('sks_praktek', $matkul->sks_praktek) }}"
                                        required>
                                    @error('sks_praktek')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="sks_lapangan"
                                        ...
                                        placeholder="SKS Lapangan" value="{{ old('sks_lapangan', $matkul->sks_lapangan) }}"
                                        required>
                                    @error('sks_lapangan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
